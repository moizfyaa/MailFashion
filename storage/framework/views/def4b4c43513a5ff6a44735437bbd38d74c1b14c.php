                                ...
                                <tr data-id="<?php echo e($id); ?>">
                                    <td data-th="Product" class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="/uploads/product/<?php echo e($details['image']); ?>" alt="" style="height: 100px">
                                        </div>
                                    ...
                                    <td class="cart__price" style="padding-left: 20px;">$<?php echo e($details['price'] * $details['quantity']); ?></td>
